...
import Data.Argonaut.Core (caseJson, Json(..), fromObject, fromArray, stringifyWithIndent, toArray, toObject, jsonSingletonObject)
...
mergeObj a p = case Object.lookup "__srcPos" p of
  ...
  where mergeObj' = Object.unionWith (\a p -> mergeAwithP a p)
